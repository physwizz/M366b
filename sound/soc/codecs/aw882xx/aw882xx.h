...
#define AW_TLV_HEADER_SIZE 	(2 * sizeof(unsigned int))
#define AW_TLV_HEADER_NUM	(2)
...
#if KERNEL_VERSION(6, 6, 18) <= LINUX_VERSION_CODE
#define AW_KERNEL_VER_OVER_6_6_18
#endif

#if KERNEL_VERSION(6, 12, 0) <= LINUX_VERSION_CODE
#define AW_KERNEL_VER_OVER_6_12_0
#endif
...
#define AW_PILOT_TONE_MAX_VALUE (1000)//mv
...
enum {
	...
	KCTL_TYPE_MON_HAL,
	KCTL_TYPE_IV_OUTPUT,
	KCTL_TYPE_PILOT_TONE_THRESHOLD,
	KCTL_TYPE_RCV_TEST_VOLUME,
	KCTL_TYPE_HMUTE,
	AW_KCTL_NUM,
...
struct aw882xx {
	...
	struct aw_big_data big_data[2];
	unsigned char num_amp;
