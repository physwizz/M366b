...
int magnetometer_ak09920c_check_adc_data_spec(s32 sensor_value[3])
{
...
static ssize_t magnetometer_ak09920c_matrix_show(char *buf)
{
...
static ssize_t magnetometer_ak09920c_matrix_store(const char *buf, size_t size)
{
	u8 val[27] = {0, };
	int ret = 0;
	int i;
...
static ssize_t magnetometer_ak09920c_cover_matrix_show(char *buf)
{
	struct magnetometer_data *data = get_sensor(SENSOR_TYPE_GEOMAGNETIC_FIELD)->data;
...
static ssize_t magnetometer_ak09920c_cover_matrix_store(const char *buf, size_t size)
{
	u8 val[27] = {0, };
	int ret = 0;
	int i;
...
static ssize_t magnetometer_ak09920c_mpp_matrix_show(char *buf)
{
	struct magnetometer_data *data = get_sensor(SENSOR_TYPE_GEOMAGNETIC_FIELD)->data;
...
static ssize_t magnetometer_ak09920c_mpp_matrix_store(const char *buf, size_t size)
{
	u8 val[27] = {0, };
	int ret = 0;
	int i;
...
static ssize_t magnetometer_ak09920c_flip_matrix_show(char *buf)
{
	struct magnetometer_data *data = get_sensor(SENSOR_TYPE_GEOMAGNETIC_FIELD)->data;
...
static ssize_t magnetometer_ak09920c_flip_matrix_store(const char *buf, size_t size)
{
	u8 val[27] = {0, };
	int ret = 0;
	int i;
...
static ssize_t magnetometer_ak09920c_selftest_show(char *buf)
{
	s8 result[4] = {-1, -1, -1, -1};
...
static ssize_t magnetometer_ak09920c_hw_offset_show(char *buf)
{
	struct magnetometer_data *data = get_sensor(SENSOR_TYPE_GEOMAGNETIC_FIELD)->data;
	struct calibration_data_ak09920c *cal_data = data->cal_data;

	return snprintf(buf, PAGE_SIZE, "%d,%d,%d\n", cal_data->offset_x, cal_data->offset_y, cal_data->offset_z);
}

struct magnetometer_factory_chipset_funcs magnetometer_ak09920c_ops = {
	.selftest_show = magnetometer_ak09920c_selftest_show,
	.hw_offset_show = magnetometer_ak09920c_hw_offset_show,
	.matrix_show = magnetometer_ak09920c_matrix_show,
	.matrix_store = magnetometer_ak09920c_matrix_store,
	.cover_matrix_show = magnetometer_ak09920c_cover_matrix_show,
	.cover_matrix_store = magnetometer_ak09920c_cover_matrix_store,
	.mpp_matrix_show = magnetometer_ak09920c_mpp_matrix_show,
	.mpp_matrix_store = magnetometer_ak09920c_mpp_matrix_store,
	.flip_matrix_show = magnetometer_ak09920c_flip_matrix_show,
	.flip_matrix_store = magnetometer_ak09920c_flip_matrix_store,
	.check_adc_data_spec = magnetometer_ak09920c_check_adc_data_spec,
};

struct magnetometer_factory_chipset_funcs *get_magnetometer_ak09920c_chipset_func(char *name)
{
	if (strcmp(name, AK09920C_NAME) != 0)
		return NULL;

	return &magnetometer_ak09920c_ops;
}
